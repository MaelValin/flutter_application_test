...
class MovieListItem {
  ...
  final String title;
  final int year;
  final String? posterUrl; // Ajout optionnel pour supporter les posters si l'API les fournit
  ...
  factory MovieListItem.fromJson(Map<String, dynamic> json) {
    return MovieListItem(
      ...
      year: json['year'] ?? 0,
      posterUrl: json['poster_url'], // Certains endpoints peuvent fournir ceci
    );
  }
  
  // Getter pour obtenir l'URL du poster ou un placeholder
  String get poster => posterUrl ?? 'https://placehold.co/80x120/1a2482/FFF?text=${title.isNotEmpty ? title[0] : "?"}';
}
